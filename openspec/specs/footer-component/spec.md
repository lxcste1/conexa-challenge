...
The `Footer` component SHALL render a credit line containing the text "development by" and a link to the author's GitHub profile (`https://github.com/lxcste1`).
...
- **WHEN** the `Footer` component is rendered
- **THEN** a link with text "@lxcste" and `href="https://github.com/lxcste1"` SHALL be present
